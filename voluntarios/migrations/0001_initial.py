# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-12-03 20:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.SmallIntegerField(choices=[(0, 'Activo'), (1, 'Inactivo'), (2, 'Pasante')], default=0)),
                ('referencia', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='voluntarios.Referencia')),
            ],
        ),
    ]
